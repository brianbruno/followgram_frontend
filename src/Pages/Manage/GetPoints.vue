                ...
                <div class="col-md-12">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <b-button v-on:click="getRequesters()" class="btn-hover-shine btn-transition float-right" variant="primary"><font-awesome-icon icon="sync" size="1x"/></b-button>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            ...
                                            <div class="widget-content-right">
                                                ...
                                                <div role="group" class="btn-group-sm btn-group d-none d-sm-none d-md-block">
                                    ...
                                    <div class="widget-content p-0">
                                        ...
                                        <div>
                                            <b-form>
                                                ...
                                                <div class="col-md-12">
                                                    <b-form-select v-model="idInstaFollowing" class="form-control-sm" size="sm" v-on:change="changeActiveAccount">
                                                        <option v-bind:key="account.id" v-for="account in accounts" :value="account.id">{{ account.username }}</option>
                                                    </b-form-select>
                                                </div>
                                            </b-form>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.idInstaFollowing = localStorage.getItem('user.insta_id_active');
